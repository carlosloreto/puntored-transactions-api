...
public class RechargeController {
        ...
        @PostMapping
        @Operation(summary = "Crear recarga", description = "Crea una nueva recarga móvil validando reglas de negocio y procesando la transacción. Requiere JWT de Supabase.", security = @SecurityRequirement(name = "bearer-token"))
        @ApiResponses(value = {
